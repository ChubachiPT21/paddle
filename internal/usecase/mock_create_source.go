...
// Source: internal/usecase/create_source.go
...
func (m *MockCreateSourceInterface) CreateSource(token string, source *orm.Source) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateSource", token, source)
	ret0, _ := ret[0].(error)
	return ret0
}

// CreateSource indicates an expected call of CreateSource.
func (mr *MockCreateSourceInterfaceMockRecorder) CreateSource(token, source interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateSource", reflect.TypeOf((*MockCreateSourceInterface)(nil).CreateSource), token, source)
}

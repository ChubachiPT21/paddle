...
func (m *MockFeedRepository) DeleteAll(sourceID int64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteAll", sourceID)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteAll indicates an expected call of DeleteAll.
func (mr *MockFeedRepositoryMockRecorder) DeleteAll(sourceID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteAll", reflect.TypeOf((*MockFeedRepository)(nil).DeleteAll), sourceID)
}
...
func (m *MockSourceRepository) Delete(sourceID int64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Delete", sourceID)
	ret0, _ := ret[0].(error)
	return ret0
}

// Delete indicates an expected call of Delete.
func (mr *MockSourceRepositoryMockRecorder) Delete(sourceID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Delete", reflect.TypeOf((*MockSourceRepository)(nil).Delete), sourceID)
}
...
// Create mocks base method.
func (m *MockUserRepository) Create(email, encryptedPassword, token string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", email, encryptedPassword, token)
	ret0, _ := ret[0].(error)
	return ret0
}

// Create indicates an expected call of Create.
func (mr *MockUserRepositoryMockRecorder) Create(email, encryptedPassword, token interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockUserRepository)(nil).Create), email, encryptedPassword, token)
}

// FindByEmail mocks base method.
func (m *MockUserRepository) FindByEmail(email string) (*orm.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) FindByToken(token string) (*orm.User, error) {
	m.ctrl.T.Helper()
